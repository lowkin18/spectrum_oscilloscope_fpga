...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { reset_in_switch }]; #IO_L19N_T3_VREF_35 Sch=SW0
...
##Pmod Header JA (XADC)
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports {adc_in_p }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p
...
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { adc_in_n }]; #IO_L21N_T3_DQS_AD14N_35 Sch=JA1_R_N
